...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{BIBLIOPHILER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{BIBLIOPHILER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
bibliophiler_server.pl - Catalyst Testserver

=head1 SYNOPSIS

bibliophiler_server.pl [options]
